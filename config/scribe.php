...
'title' => config('app.name') . 'Friidrett API',
'description' => 'Åpne lese-endepunkter (GET). Skriving (POST) vil etter hvert kreve auth. ',
  ...
  'auth' => [
    'enabled' => true,
    'in' => 'bearer',              // viser "Authorization: Bearer ..."
    'name' => 'Authorization',
    'use_value' => env('SCRIBE_AUTH_KEY'), // lar /docs auto-fylle header
